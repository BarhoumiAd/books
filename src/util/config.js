class Config {
  constructor() {
    ...
    this.pgDbName = process.env.PG_DB_NAME || 'demo';
    ...
    this.pgUrl = `postgres://${this.pgUser}:${this.pgPassword}@${this.pgHost}:${this.pgPort}`;
    this.SYNCUP_NEEDED = 'syncup_needed_';
    this.SYNCUP_PERIODE = 5000;
  }
